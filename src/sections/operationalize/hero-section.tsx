    ...
    return (
        <div className='w-full relative h-[646px] overflow-y-hidden mb-[60px]'>
            ...
            <div className='flex flex-col items-center py-[60px]'>
                ...
                <p className='text-xl font-medium w-[36%] text-center pt-7'>
                    We guide you in operationalizing AI, ensuring smooth deployment, scalability, and alignment with your business goals for maximum impact.
                </p>
